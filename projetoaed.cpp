...
/// This is the Complete Description
    ...
    int main() {
        ...
        myFile.open("/Users/goncalocosta/Desktop/projetoaed/schedule/classes.csv");
        ...
        myFile.open("/Users/goncalocosta/Desktop/projetoaed/schedule/classes_per_uc.csv");
        getline(myFile,CurrentLine);
        while(getline(myFile,CurrentLine)) {
            stringstream inputString(CurrentLine);
        ...
        myFile.open("/Users/goncalocosta/Desktop/projetoaed/schedule/students_classes.csv");
        getline(myFile,CurrentLine);
